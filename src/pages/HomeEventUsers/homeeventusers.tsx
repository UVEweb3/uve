...
import "./customeventusers.css";
import { useContractUtils } from '@/app/hooks';
import { dAppContext } from '@/Context/dappContext';
import { useAccount } from '@gear-js/react-hooks';
import { Container, Row, Col, Image, ButtonGroup, Dropdown, Badge, Button,ProgressBar } from 'react-bootstrap';
      ...
      >
        ...
        <Row className="event-info mb-4">
          <Col xs={12} md={12} className="event-created-info mb-3">
            <h2 className=' desktop-margin' >My Events : 1  </h2>
          </Col>
          ...
          {/* Barra de búsqueda */}
        <Row className="search-bar-container mb-4">
        ...
        {/* Evento con ProgressBar */}
        <Row className="justify-content-center align-items-center mt-5 mb-5">
          <Col xs={12} md={6} className="mx-auto event-item-container">
            <div className="event-item text-left">
              <Image 
              ...
              />
              <h3 className="event-title mt-3">Marketing Web3</h3>
              <div className="d-flex align-items-center justify-content-between progress-container mt-2">
          ...
          <Col xs={12} md={6} className="mx-auto event-item-container">
            <div className="event-item text-left">
              ...
              />
              <h3 className="event-title mt-3">Marca personal</h3>
              <div className="d-flex align-items-center justify-content-between progress-container mt-2">
                <ProgressBar now={now} className="certifications-progress flex-grow-1" />
                <span className="progress-label ml-3">{`${now}%`}</span>
              </div>
